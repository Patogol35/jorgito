...
/* ========================= CONFIG ========================= */
const WHATSAPP_URL =
  "[https://wa.me/593997979099?text=Hola%20Jorge,%20vi%20tu%20portafolio](https://wa.me/593997979099?text=Hola%20Jorge,%20vi%20tu%20portafolio)";
...
function getSmartResponse(message, context) {
  ...
  if (thanksMatch) {
    ...
    if (!name) {
      return { text: replies.GRA, intent: "GRA" };
    }
  ...
  if (moodMatch) {
    ...
    if (!name || name === BOT_NAME) {
      return { text: replies.MOOD, intent: "MOOD" };
    }
  ...
  if (doingMatch) {
    ...
    if (!name || name === BOT_NAME) {
      return { text: replies.WHAT_DOING, intent: "WHAT_DOING" };
    }
